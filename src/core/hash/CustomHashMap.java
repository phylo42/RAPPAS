 ...
 * <tt>null</tt> values and the <tt>null</tt> key.  (The <tt>CustomHashMap</tt>
 ...
 * <tt>CustomHashMap</tt> instance (the number of buckets) plus its size (the number
 * of key-value mappings).  Thus, it's very important not to set the initial
 * capacity too high (or the load factor too low) if iteration performance is
 * important.
 *
 * <p>An instance of <tt>CustomHashMap</tt> has two parameters that affect its
 ...
 * the operations of the <tt>CustomHashMap</tt> class, including
 ...
 *
 * <p>If many mappings are to be stored in a <tt>CustomHashMap</tt>
 ...
 *   Map m = Collections.synchronizedMap(new CustomHashMap(...));</pre>
 *
...
public class CustomHashMap<Word,Tuple> extends CustomAbstractMap<Word,Tuple>
     ...
     * complicated by the existence of subclass LinkedCustomHashMap. See
     * below for hook methods defined to be invoked upon insertion,
     * removal and access that allow LinkedCustomHashMap internals to
     ...
     * the CustomHashMap or otherwise modify its internal structure (e.g.,
     * rehash).  This field is used to make iterators on Collection-views of
     * the CustomHashMap fail-fast.  (See ConcurrentModificationException).
     */
    ...
    /**
     * Constructs an empty <tt>CustomHashMap</tt> with the specified initial
    ...
    /**
     * Constructs an empty <tt>CustomHashMap</tt> with the default initial capacity
    ...
    /**
     * Constructs a new <tt>CustomHashMap</tt> with the same mappings as the
     * specified <tt>Map</tt>.  The <tt>CustomHashMap</tt> is created with
    ...
    /**
     * Returns a shallow copy of this <tt>CustomHashMap</tt> instance: the keys and
    ...
    /**
     * Save the state of the <tt>CustomHashMap</tt> instance to a stream (i.e.,
     * serialize it).
     *
     * @serialData The <i>capacity</i> of the CustomHashMap (the length of the
    ...
    /**
     * Reconstitute the {@code CustomHashMap} instance from a stream (i.e.,
     * deserialize it).
     */
    ...
    static class CustomHashMapSpliterator<K,V> {
        ...
        CustomHashMapSpliterator(CustomHashMap<K,V> m, int origin,
                           int fence, int est,
    ...
    static final class KeySpliterator<K,V>
        extends CustomHashMapSpliterator<K,V>
        implements Spliterator<K> {
        KeySpliterator(CustomHashMap<K,V> m, int origin, int fence, int est,
                       int expectedModCount) {
    ...
    static final class ValueSpliterator<K,V>
        ...
        ValueSpliterator(CustomHashMap<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class EntrySpliterator<K,V>
        ...
        EntrySpliterator(CustomHashMap<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    /* ------------------------------------------------------------ */
    // LinkedCustomHashMap support


    /*
     * The following package-protected methods are designed to be
     * overridden by LinkedCustomHashMap, but not by any other subclass.
     * Nearly all other internal methods are also package-protected
     * but are declared final, so can be used by LinkedCustomHashMap, view
     * classes, and HashSet.
     */
    ...
    /**
     * Entry for Tree bins. Extends LinkedCustomHashMap.Entry (which in turn
     * extends Node) so can be used as extension of either regular or
     * linked node.
     */
    public static final class TreeNode<K,V> extends CustomLinkedHashMap.Entry<K,V> {
         ...
         * this node.
         */
        public final Node<K,V> untreeify(CustomHashMap<K,V> map) {
         ...
         */
        public final TreeNode<K,V> putTreeVal(CustomHashMap<K,V> map, Node<K,V>[] tab,
                                       int h, K k, V v) {
            Class<?> kc = null;
         ...
         */
        public final void removeTreeNode(CustomHashMap<K,V> map, Node<K,V>[] tab,
                                  boolean movable) {
            int n;
         ...
         */
        public final void split(CustomHashMap<K,V> map, Node<K,V>[] tab, int index, int bit) {
            TreeNode<K,V> b = this;
