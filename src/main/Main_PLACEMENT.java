...
//            String pp=wd+"rst";
            ...
            int preplacementWordSampling=QueryKnife.SAMPLING_NON_OVERLAPPING;
            ...
            //word sampling method
            int wordSampling=QueryKnife.SAMPLING_NON_OVERLAPPING;
            //searchMethod
...
//                                }
                ...
                for (int diagsumPosToAnalyse:diagsumPosToAnalyseFurther) {
                    ...
                    for (int i = 0; i < nodesToAnalyse.length; i++) {
                        ...
                        // LOOP ON QUERY WORDS
                        QueryWord qw=null;
                        QueryKnife rk=new QueryKnife(fasta, k, min_k, s, wordSampling);
                        while ((qw=rk.getNextWord())!=null) {
                            //Infos.println("Query mer: "+qw.toString());
