 ...
 * @author ben
 */
public class Main_PLACEMENT_V02_align_toptuplestoscorefromalign {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (s instanceof DNAStates)
                analysisType=Main_PLACEMENT_V02_align_toptuplestoscorefromalign.TYPE_DNA;
            else if (s instanceof AAStates)
                analysisType=Main_PLACEMENT_V02_align_toptuplestoscorefromalign.TYPE_PROTEIN;
            ...
            while ((fasta=fp.nextSequenceAsFastaObject())!=null) {
                ...
                if (!fasta.getHeader().equals("GLKT0ZE01ECJ6B"))
                    continue;
                ...
                ///////////////////////////////////////////////////////
                boolean[] nodesEncountered=new boolean[tree.getNodeCount()]; //tab[nodeId]=true/false
...
//                }
            ...
            Logger.getLogger(Main_PLACEMENT_V02_align_toptuplestoscorefromalign.class.getName()).log(Level.SEVERE, null, ex);
        }
