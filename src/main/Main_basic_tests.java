...
//            File coronavirusAlignment=new File("/media/ben/STOCK/DATA/NCBI_VIROMES/Coronaviridae_sources/alignments/Concatenation_abMNS_mafft_auto.fasta");
            //partitions
//            Partition p_a=new Partition("a", 0, 34597); //34598
//            Partition p_b=new Partition("b", 34598, 46243); //11646  , 46244
//            Partition p_M=new Partition("M", 46244, 47642); //1399  ,47643
//            Partition p_N=new Partition("N", 47643, 50078); //2436  ,50079
//            Partition p_S=new Partition("S", 50079, 63640); //13562 ,63641
...
//            partitions.add(p_S);
            ...
            ////////////////////////////////
            //TEST BASIC FASTML
//            File alignmentFile=new File("/media/ben/STOCK/DATA/ancestral_reconstruct_tests/fastml/all_RNApol/mod_mafft_centroids.derep_prefix.Coronoviridae_RNApol_all_VIPR_20-07-2016_CdsFastaResults_CORRECTED.fasta");
//            File treeFile=new File("/media/ben/STOCK/DATA/ancestral_reconstruct_tests/fastml/all_RNApol/tree.newick.txt");
//            File treeAncestor=new File("/media/ben/STOCK/DATA/ancestral_reconstruct_tests/fastml/all_RNApol/tree.ancestor.txt");
//            File probaFile=new File("/media/ben/STOCK/DATA/ancestral_reconstruct_tests/fastml/all_RNApol/prob.marginal.txt");
           
            ////////////////////////
            //TEST BASIC PAML
            File alignmentFile=new File("/media/ben/STOCK/DATA/ancestral_reconstruct_tests/paml/alpha_RNApol/mafft_centroids.derep_prefix.Coronovirinae_alpha_RNApol_all_VIPR_20-07-2016_CdsFastaResults_CORRECTED.fasta");
            File treeFile=new File("/media/ben/STOCK/DATA/ancestral_reconstruct_tests/paml/alpha_RNApol/model_JC/rst");
            File probaFile=new File("/media/ben/STOCK/DATA/ancestral_reconstruct_tests/paml/alpha_RNApol/model_JC/rst");
            //File readsFile=new File("/media/ben/STOCK/DATA/NCBI_VIROMES/blast_extractions/coronavirus/extract_ERR1360080_1e-25_99_80");
            //File readsFile=new File("/media/ben/STOCK/DATA/NCBI_VIROMES/blast_extractions/coronavirus/extract_mod_ERR1360080_1e-25_100_80");
            File readsFile=new File("/media/ben/STOCK/DATA/viromeplacer/alphaTest1");
        ...
        c.store(new File("/media/ben/STOCK/DATA/ancestral_reconstruct_tests/paml/pplacer_refpkg/vaginal_16s/pplacer_demoset_params_"+k+"_"+k+"_1e-6_1e-6"));
        ...
        final Session session=Session.load(new File("/media/ben/STOCK/DATA/ancestral_reconstruct_tests/paml/alpha_RNApol/PAML_session_params_"+k+"_"+k+"_1e-6_1e-6_coronavirus_alpha"));
...
//                            }
                ...
                Logger.getLogger(Main_basic_tests.class.getName()).log(Level.SEVERE, null, ex);
            }
